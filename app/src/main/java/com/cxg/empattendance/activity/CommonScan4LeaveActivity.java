...
* @create 2018/8/27
*/
public final class CommonScan4LeaveActivity extends Activity implements ScanListener, View.OnClickListener {
    static final String TAG = CommonScan4LeaveActivity.class.getSimpleName();
    ...
    */
    public void scanResult(Result rawResult, Bundle bundle) {
        ...
        if (!"".equals(rawResult.getText())) {
            Intent intent=new Intent(CommonScan4LeaveActivity.this,EmpLeaveAnddismissionActivity.class);
